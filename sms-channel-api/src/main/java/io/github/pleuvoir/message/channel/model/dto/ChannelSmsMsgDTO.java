...
public class ChannelSmsMsgDTO implements Serializable, ToJSON {
    ...
    private String signCode;            //通道短信签名编号

    private String signName;            //通道短信签名名称
