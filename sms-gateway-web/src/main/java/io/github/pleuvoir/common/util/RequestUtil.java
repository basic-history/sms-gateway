...
public class RequestUtil {
	...
	public static Map<String, String> getParameterMap(HttpServletRequest request){
		...
		while(names.hasMoreElements()){
			...
			String parametersValue=request.getHeader(parametersName);
	...
	/**
	 * 获取请求body（废弃，使用 CachingRequestWrapper）
	 * @return
	 * @throws IOException
	 */
//	public static String receiveBody(HttpServletRequest request) throws IOException {
//
//		try(
